...
<main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
        ...
        <div class="flex justify-between items-center mt-6 mb-4">
            ...
            <div class="space-x-2">
                <button class="inline-flex items-center px-4 py-2 text-white bg-green-400 hover:bg-green-600 rounded-md text-sm">
                    <i class="fas fa-download mr-2"></i> Download
                </button>
                <button class="inline-flex items-center px-4 py-2 text-white bg-blue-500 hover:bg-blue-600 rounded-md text-sm">
