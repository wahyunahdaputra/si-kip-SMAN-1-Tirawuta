...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
    ...
    <body>
        <div
            ...
            <aside
                ...
                <div class="py-4 text-gray-500 dark:text-gray-400">
                    ...
                    <ul class="mt-6">
                        ...
                        <button @click="isOpen = !isOpen" class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" aria-haspopup="true">
                            ...
                            <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <span class="ml-4 text-left">Tata Pamong, Tata Kelola & Kerjasama</span>
                            </span>
                    ...
                    <li id="mahasiswa" class="relative px-6 py-3" x-data="{ isOpen: dropdownStatus.mahasiswa }">
                        ...
                        <ul x-show="isOpen" @click.away="isOpen = false" class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900" aria-label="submenu">
                            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="pages/login.html">LKPS</a>
                            </li>
                            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="pages/create-account.html">
                                    LED
            ...
            <!-- With actions -->
            <h3
              class="mb-4 text-lg font-semibold text-black-600 dark:text-gray-300 text-center justify-center"
            >
                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      ...
                      <th class="px-4 py-3">Fakultas <input type="text"></th>
                  ...
                  <tbody class="text-sm bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    <?php $no=1; foreach ($dataProgramStudi as $row) : ?>
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3"><?= $no++; ?></td>
                            <td class="px-4 py-3"><?= $row->fakultas; ?></td>
                            <td class="px-4 py-3"><?= $row->program; ?></td>
                            <td class="px-4 py-3"><?= $row->program_studi; ?></td>
                            <td class="px-4 py-3"><?= $row->pr_akreditasi; ?></td>
                            <td class="px-4 py-3"><?= $row->tgl_sk; ?></td>
                            <td class="px-4 py-3"><?= $row->tgl_kadaluarsa; ?></td>
                            <td class="px-4 py-3"><?= $row->no_sk; ?></td>
                            <td class="px-4 py-3"><?= $row->tgl_hariini; ?></td>
                            <td class="px-4 py-3"><?= $row->status_kadaluarsa; ?></td>
                            <td class="px-4 py-3"><?= $row->akr_oleh; ?></td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
                </table>
