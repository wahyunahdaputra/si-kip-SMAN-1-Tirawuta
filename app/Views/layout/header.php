                    ...
                    <ul>
                        ...
                        <li class="relative px-6 py-3">
                            <a
                                ...
                                <span class="ml-4">Data Peminat & Daya Tampung</span>
                            </a>
                        </li>
                        <li class="relative px-6 py-3">
                            <button
                        ...
                        <li class="relative px-6 py-3">
                            <a
                                ...
                                <span class="ml-4">Data Peringkat Akreditasi</span>
                            </a>
                        </li>
                        <li class="relative px-6 py-3">
                            <a
                                ...
                                <span class="ml-4">Data Akreditasi Eksternal Program Studi</span>
                            </a>
                        </li>
                        <li class="relative px-6 py-3">
                            <a
                                ...
                                <span class="ml-4">Data Kerjasama Perguruan Tinggi</span>
                            </a>
                        </li>
                        <li class="relative px-6 py-3">
                            <a
                                ...
                                <span class="ml-4">Data Rekognisi Dosen</span>
                            </a>
                        </li>
                        <li class="relative px-6 py-3">
                            <button
                            ...
                            <template x-if="isPagesMenuOpen">
                                <ul
                                    ...
                                    <li
                                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                        <a class="w-full" href="pages/login.html">Buku ISBN Dosen UHO</a>
                                    </li>
                                    <li
                                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                        <a class="w-full" href="pages/create-account.html">
